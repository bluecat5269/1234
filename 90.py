...
img1_path = r'test2.jpg'
img2_path = r'test4.jpg'
similary_ORB= ORB_img_similarity(img1_path, img2_path)
print('ORB:',similary_ORB)
similary_phash=phash_img_similarity(img1_path, img2_path)
print('phash:',similary_phash)
similary_hist=calc_similar_by_path(img1_path, img2_path)
print('hist:',similary_hist)
...
r=calc_image_similarity(img1_path, img2_path)
print(r)